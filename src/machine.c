...
static void dump_context() {
  fprintf(stderr,
          "gp0=" PFUINT " gp1=" PFUINT " gp2=" PFUINT " gp3=" PFUINT "\n"
          "gp4=" PFUINT " gp5=" PFUINT " gp6=" PFUINT " gp7=" PFUINT "\n"
          "af=" PFUINT " ef=" PFUINT " ip=" PFUINT "\n",
          machine.ctx.gp0, machine.ctx.gp1, machine.ctx.gp2, machine.ctx.gp3, machine.ctx.gp4,
          machine.ctx.gp5, machine.ctx.gp6, machine.ctx.gp7, machine.ctx.af, machine.ctx.ef,
          machine.ctx.ip);
}
